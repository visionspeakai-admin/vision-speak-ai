  ...
  const quickStart = [
    {
      step: 1,
      title: 'Get API Key',
      description: 'Sign up and generate your API key from the dashboard in under 60 seconds.',
  ...
  const endpoints = [
    {
      ...
      method: 'POST',
      description: 'Analyze lip movements and generate transcriptions from video input.',
    ...
    },
    {
      ...
      method: 'POST',
      description: 'Detect and classify hand/body gestures from video or depth data.',
    ...
    },
    {
      ...
      path: '/api/v1/stream',
      method: 'WebSocket',
      description: 'Continuous gesture and lip-reading detection from live video streams.',
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="heading-lg mb-4 text-pretty">Get Started in 3 Steps</h2>
      ...
      {/* API Endpoints */}
      <section id="api-reference" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          {endpoints.map((endpoint, index) => (
            <div key={index} className="glass-effect p-8 rounded-xl">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
                <div>
                  <h3 className="text-lg font-bold text-white mb-2">{endpoint.name}</h3>
              ...
              <div className="bg-black/20 p-4 rounded-lg mb-6">
                <code className="text-sm font-mono text-cyan-300">{endpoint.path}</code>
              </div>

              <div>
                <p className="text-xs font-semibold text-slate-400 mb-3">Parameters:</p>
                <div className="flex flex-wrap gap-2">
                  {endpoint.params.map((param, idx) => (
                    <span key={idx} className="px-3 py-1 rounded-full text-xs bg-white/5 text-slate-300 border border-white/10">
                      {param}
                    </span>
                  ))}
                </div>
          ...
          {codeExamples.map((example, index) => (
            <div key={index} className="glass-effect rounded-xl overflow-hidden">
              <div className="flex items-center justify-between p-4 border-b border-white/10">
                <span className="font-mono font-bold text-cyan-300">{example.language}</span>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="body-text max-w-2xl mx-auto">
            Download our official SDKs with built-in support for NVIDIA acceleration.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            { name: 'JavaScript/TypeScript', version: '1.2.0', downloads: '35K+' },
            ...
            <div key={index} className="glass-effect p-6 rounded-xl flex flex-col justify-between">
              <div className="mb-4">
