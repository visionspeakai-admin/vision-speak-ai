  ...
  const techDetails = [
    {
      ...
      description: 'State-of-the-art transformer models trained on 10M+ video samples with multi-language lip-reading capabilities.',
    ...
    },
    {
      ...
      description: 'Full NVIDIA acceleration stack enabling 45% faster inference on RTX and A100 GPUs with optimized memory management.',
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: 'Real-time Processing',
      description: 'Sub-100ms latency processing for live video streams with adaptive quality based on hardware capabilities.',
      badge: 'NVIDIA-Powered',
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: 'Edge & Cloud Ready',
      description: 'Deploy on-premises or cloud with end-to-end encryption, local processing options, and zero data retention.',
    },
    {
      icon: <Network className="w-6 h-6" />,
      title: 'Multi-Modal Learning',
      description: 'Combines visual lip-reading with audio data for improved accuracy and robustness across environments.',
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: 'Adaptive Inference',
      description: 'Model quantization and pruning for edge devices with 99.2% accuracy retention on mobile hardware.',
    },
  ]
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="body-text max-w-2xl mx-auto">
            Built with cutting-edge machine learning frameworks and NVIDIA GPU acceleration.
          </p>
        </div>
      ...
      <section className="relative py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="mb-12">
          <div className="inline-block mb-4 px-4 py-2 rounded-full glass-effect">
            <span className="text-cyan-400 text-sm font-semibold">Primary Integration</span>
          </div>
          <h2 className="heading-lg mb-6 text-pretty">NVIDIA GPU Acceleration</h2>
          <p className="body-text max-w-3xl mb-10">
            VisionSpeakAI's performance foundation is built on NVIDIA's CUDA and cuDNN technology stack. By leveraging GPU compute capabilities, we achieve unprecedented speed and efficiency in real-time AI inference. Our models are optimized for NVIDIA's full range of GPUs, from consumer RTX cards to enterprise A100 accelerators.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            {benchmarks.map((bench, index) => (
              <div key={index} className="glass-effect p-6 rounded-xl text-center">
                ...
                <p className={`text-3xl md:text-4xl font-bold ${bench.color} mb-2`}>{bench.value}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="glass-effect p-8 rounded-xl">
              ...
              <h3 className="text-lg font-bold text-white mb-3">CUDA Compute</h3>
              <ul className="space-y-2 text-sm text-slate-400">
                <li className="flex gap-2">
                  <span className="text-cyan-400">•</span> 10000+ CUDA cores utilization
                </li>
                <li className="flex gap-2">
                  <span className="text-cyan-400">•</span> Mixed precision FP16/INT8
                </li>
                <li className="flex gap-2">
                  <span className="text-cyan-400">•</span> Memory bandwidth optimized
                </li>
              </ul>
            </div>
            ...
            <div className="glass-effect p-8 rounded-xl">
              ...
              <h3 className="text-lg font-bold text-white mb-3">cuDNN Library</h3>
              <ul className="space-y-2 text-sm text-slate-400">
                <li className="flex gap-2">
                  <span className="text-lime-400">•</span> Optimized neural ops
                </li>
                <li className="flex gap-2">
                  <span className="text-lime-400">•</span> Tensor Cores acceleration
                </li>
                <li className="flex gap-2">
                  <span className="text-lime-400">•</span> Auto-tuning capabilities
                </li>
              </ul>
            </div>
            ...
            <div className="glass-effect p-8 rounded-xl">
              ...
              <h3 className="text-lg font-bold text-white mb-3">GPU Hardware</h3>
              <ul className="space-y-2 text-sm text-slate-400">
                <li className="flex gap-2">
                  <span className="text-purple-400">•</span> RTX 3090/4090 supported
                </li>
                <li className="flex gap-2">
                  <span className="text-purple-400">•</span> A100 enterprise grade
                </li>
                <li className="flex gap-2">
        ...
        <div className="glass-effect p-8 md:p-12 rounded-2xl">
          <h3 className="text-xl font-bold text-white mb-6">CPU vs GPU Performance</h3>
          <div className="space-y-4">
            {[
              { name: 'Inference Latency', cpu: '450ms', gpu: '78ms', improvement: '5.8x faster' },
              { name: 'Batch Throughput', cpu: '8 FPS', gpu: '240 FPS', improvement: '30x increase' },
              { name: 'Power Consumption', cpu: '180W', gpu: '250W', improvement: '30% efficient' },
              { name: 'Cost per Inference', cpu: '€0.042', gpu: '€0.006', improvement: '7x cheaper' },
            ].map((comp, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                <div className="flex-1">
                  ...
                  <div className="flex gap-4 text-sm">
                    ...
                    <span className="text-cyan-400 font-semibold">GPU: {comp.gpu}</span>
                  </div>
                </div>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="heading-lg mb-6 text-pretty">Model Training & Data</h2>
          ...
          <div className="glass-effect p-8 md:p-12 rounded-2xl">
            <h3 className="text-lg font-bold text-white mb-6">Model Architecture</h3>
...
└── Softmax Output (95% accuracy)`}
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="body-text max-w-2xl mx-auto">
            VisionSpeakAI supports a range of deployment scenarios from edge computing to cloud-scale inference.
          </p>
        </div>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center glass-effect p-12 rounded-2xl">
          <h2 className="heading-lg mb-4 text-pretty">Ready for Production Deployment?</h2>
