    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {mode === 'gesture' && (
              <div className="glass-effect p-6 rounded-xl">
                <h3 className="font-bold text-white mb-2">Gesture Recognition Mode</h3>
                <p className="text-sm text-slate-400">
                  The model detects and classifies hand and body gestures in real-time. Try common gestures like thumbs up, peace sign, or custom hand signals.
                </p>
              </div>
            )}
          </div>
            ...
            <div className="glass-effect p-6 rounded-xl">
              ...
              {!isRecording ? (
                <div className="space-y-3 text-center text-slate-400">
                  <p className="text-sm">Enable your webcam to see live results</p>
                </div>
              ) : (
                  ...
                  {mode === 'lip-read' ? (
                    <>
                      <div className="p-3 bg-white/5 rounded-lg">
                        <p className="text-xs text-slate-500 mb-2">Transcription</p>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 bg-white/5 rounded-lg">
                          ...
                          <p className="text-lime-300 font-bold text-lg">94.2%</p>
                        </div>
                        <div className="p-3 bg-white/5 rounded-lg">
                          <p className="text-xs text-slate-500">Latency</p>
                          <p className="text-lime-300 font-bold text-lg">78ms</p>
                        </div>
                      </div>
                    </>
                  ) : (
                    <>
                      <div className="space-y-2">
                        {['Thumbs Up', 'Open Hand', 'Pointing'].map((gesture) => (
                          <div key={gesture} className="flex items-center justify-between p-2 bg-white/5 rounded">
                            <span className="text-sm text-slate-300">{gesture}</span>
                            <span className="text-cyan-300 font-bold text-sm">92%</span>
                          </div>
                        ))}
                      </div>
                      <div className="p-3 bg-white/5 rounded-lg">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {[
            {
              title: 'Privacy First',
              description: 'All processing happens locally in your browser. No data is stored or transmitted to our servers.',
            },
            {
              title: 'NVIDIA-Powered',
              description: 'Experience sub-100ms latency with GPU acceleration. Works on most modern devices.',
            },
            {
              title: 'Production Ready',
              description: 'The same models used by our enterprise customers. Try before you integrate.',
            },
          ].map((feature, index) => (
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center glass-effect p-12 rounded-2xl">
          <h2 className="heading-lg mb-4 text-pretty">Impressed? Let's Build Together</h2>
          <p className="body-text mb-8">
            Integrate VisionSpeakAI into your application with our production-grade APIs and SDKs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/developers" className="glow-button">
              Get API Access
            </a>
            <a href="/pricing" className="px-6 py-3 font-semibold rounded-lg border border-cyan-500/30 hover:border-cyan-400 hover:bg-cyan-400/10 transition-all">
              View Pricing
            </a>
          </div>
        </div>
