          ...
          <div className='relative glass-effect-strong border-2 border-white/10 p-10 rounded-3xl shadow-[0_0_80px_rgba(0,242,255,0.2)]'>
            <div className='mb-8'>
              ...
              <p className='text-slate-400 text-sm'>
                Sign in to your VisionSpeak account
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className='space-y-5'>
              ...
              <div className='flex items-center justify-between pt-2'>
                <label className='flex items-center gap-2 cursor-pointer group'>
                  <input
                    type='checkbox'
                    className='w-4 h-4 rounded bg-white/10 border border-white/20 checked:bg-cyan-500 checked:border-cyan-500 transition-colors'
                  />
