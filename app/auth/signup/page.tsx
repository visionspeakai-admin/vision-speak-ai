        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4 py-12 relative overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
                <motion.h1
                    ...
                    style={{
                        background: 'linear-gradient(135deg, #8b5cf6 0%, #00f2ff 50%, #8b5cf6 100%)',
                ...
                <div className="relative">
                    ...
                    <div className="relative glass-effect-strong border-2 border-white/10 p-10 rounded-3xl shadow-[0_0_80px_rgba(139,92,246,0.2)]">
                        <div className="mb-8">
                            ...
                            <p className="text-slate-400 text-sm">Join the future of AI-powered communication</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="name" className="block text-xs font-black uppercase tracking-widest text-slate-400">
                                    Full Name
                                </label>
                                <input
                                    id="name"
                            ...
                            {/* Company */}
                            <div className="space-y-2">
                                <label htmlFor="company" className="block text-xs font-black uppercase tracking-widest text-slate-400">
                                    ...
                                    >
                                        <div className="flex gap-1">
                                            {[1, 2, 3].map((i) => (
                                                <div
                                                    key={i}
                                                    className={`h-1.5 flex-1 rounded-full transition-all duration-300 ${(passwordStrength === 'strong' && i <= 3) ||
                            ...
                            {/* Confirm Password */}
                            <div className="space-y-2">
                                <label htmlFor="confirm_password" className="block text-xs font-black uppercase tracking-widest text-slate-400">
                                    Confirm Password
                                </label>
                                <input
                                    id="confirm_password"
                            ...
                            <label className="flex items-start gap-3 cursor-pointer group pt-2">
                                ...
                                <span className="text-xs text-slate-400 leading-relaxed group-hover:text-slate-300 transition-colors">
                                    I agree to the{' '}
                                    <a href="/terms" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                                        Terms of Service
                                    </a>{' '}
                                    and{' '}
                                    <a href="/privacy" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                                        Privacy Policy
                                    </a>
                                </span>
                            </label>
