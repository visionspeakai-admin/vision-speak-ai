        ...
        <div className='grid grid-cols-1 md:grid-cols-6 gap-12 mb-16'>
          ...
          <div className='md:col-span-2 space-y-6'>
            ...
            <div className='flex gap-3 mt-4'>
              <a
                href='https://x.com/VisionSpeakAI'
                target='_blank'
              ...
              <a
                href='https://www.pinterest.com/VisionSpeakAI/'
                target='_blank'
                rel='noopener noreferrer'
                className='p-2 hover:bg-white/10 rounded-lg transition-colors border border-transparent hover:border-white/5'
              >
              ...
              <a
                href='https://www.youtube.com/@VisionSpeakAI'
                target='_blank'
                rel='noopener noreferrer'
                className='p-2 hover:bg-white/10 rounded-lg transition-colors border border-transparent hover:border-white/5'
              >
              ...
              <a
                href='https://www.facebook.com/VisionSpeakAI/'
                target='_blank'
                rel='noopener noreferrer'
                className='p-2 hover:bg-white/10 rounded-lg transition-colors border border-transparent hover:border-white/5'
              >
          ...
          <div className='md:col-span-4 grid grid-cols-2 sm:grid-cols-4 gap-8'>
            {Object.entries(footerLinks).map(([category, links]) => (
              <div key={category}>
                <h3 className='font-bold text-xs uppercase tracking-widest mb-6 text-slate-500'>
                  {category}
                </h3>
