      ...
      <div className='absolute inset-0 -z-10'>
        ...
        {backgroundVariant === "gradient" && (
          <>
            ...
            <div
              className='absolute bottom-0 right-0 w-[500px] h-[500px] bg-lime-bio/5 rounded-full blur-[120px] translate-x-1/2 translate-y-1/2 animate-float'
      ...
      <div className='relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
        ...
        {badgeText && (
          <div className='inline-block mb-8 px-5 py-2 rounded-2xl glass-effect-strong animate-fade-up border-cyan-electric/20 shadow-[0_0_20px_rgba(0,242,255,0.1)]'>
            <span className='text-cyan-electric text-xs font-black uppercase tracking-[0.3em]'>
              {badgeText}
            </span>
          </div>
        )}
        ...
        {subtitle && (
          <p
            className='text-3xl md:text-4xl mb-8 max-w-3xl font-bold mx-auto animate-fade-up text-white/80'
        ...
        {(primaryCta || secondaryCta) && (
          ...
          >
            ...
            {secondaryCta && (
              <Link href={secondaryCta.href} className='glow-button-secondary'>
                {secondaryCta.text}
              </Link>
            )}
          </div>
